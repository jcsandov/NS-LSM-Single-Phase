...
module global_mpi
  ...
  ! Real precision for MPI communication
  ...
  ! 1D communicators for Pascal Algorithm
  ...
  type(cart_comm_1d), dimension(:), allocatable :: comm1d_csi
  type(cart_comm_1d), dimension(:), allocatable :: comm1d_eta
  type(cart_comm_1d), dimension(:), allocatable :: comm1d_zet
