subroutine TotalWaterVolume( phizero           , &
   ...
   if ( present( TriangulationCase ) )  then
      ...
      print *, 'In TotalWaterVolume, CASE # ', TriangulationCase

      select case ( TriangulationCase )

         case(1) ! Main diagonal from v0 --> v6

            TetrahedronAux( 1 , 1:4 ) = (/0, 5, 1, 6/) ! cell vertices of the tetrahedron # 1
            TetrahedronAux( 2 , 1:4 ) = (/0, 1, 2, 6/) ! cell vertices of the tetrahedron # 2
            TetrahedronAux( 3 , 1:4 ) = (/0, 2, 3, 6/) ! cell vertices of the tetrahedron # 3
            TetrahedronAux( 4 , 1:4 ) = (/0, 3, 7, 6/) ! cell vertices of the tetrahedron # 4
            TetrahedronAux( 5 , 1:4 ) = (/0, 7, 4, 6/) ! cell vertices of the tetrahedron # 5
            TetrahedronAux( 6 , 1:4 ) = (/0, 4, 5, 6/) ! cell vertices of the tetrahedron # 6

         case(2) ! Main diagonal from v1 --> v7

            TetrahedronAux( 1 , 1:4 ) = (/1, 6, 2, 7/) ! cell vertices of the tetrahedron # 1
            TetrahedronAux( 2 , 1:4 ) = (/1, 2, 3, 7/) ! cell vertices of the tetrahedron # 2
            TetrahedronAux( 3 , 1:4 ) = (/1, 3, 0, 7/) ! cell vertices of the tetrahedron # 3
            TetrahedronAux( 4 , 1:4 ) = (/1, 0, 4, 7/) ! cell vertices of the tetrahedron # 4
            TetrahedronAux( 5 , 1:4 ) = (/1, 4, 5, 7/) ! cell vertices of the tetrahedron # 5
            TetrahedronAux( 6 , 1:4 ) = (/1, 5, 6, 7/) ! cell vertices of the tetrahedron # 6

         case(3)! Main diagonal from v2 --> v4

            TetrahedronAux( 1 , 1:4 ) = (/2, 7, 3, 4/) ! cell vertices of the tetrahedron # 1
            TetrahedronAux( 2 , 1:4 ) = (/2, 3, 0, 4/) ! cell vertices of the tetrahedron # 2
            TetrahedronAux( 3 , 1:4 ) = (/2, 0, 1, 4/) ! cell vertices of the tetrahedron # 3
            TetrahedronAux( 4 , 1:4 ) = (/2, 1, 5, 4/) ! cell vertices of the tetrahedron # 4
            TetrahedronAux( 5 , 1:4 ) = (/2, 5, 6, 4/) ! cell vertices of the tetrahedron # 5
            TetrahedronAux( 6 , 1:4 ) = (/2, 6, 7, 4/) ! cell vertices of the tetrahedron # 6

         case(4) ! Main diagonal from v3 --> v5

            TetrahedronAux( 1 , 1:4 ) = (/3, 4, 0, 5/) ! cell vertices of the tetrahedron # 1
            TetrahedronAux( 2 , 1:4 ) = (/3, 0, 1, 5/) ! cell vertices of the tetrahedron # 2
            TetrahedronAux( 3 , 1:4 ) = (/3, 1, 2, 5/) ! cell vertices of the tetrahedron # 3
            TetrahedronAux( 4 , 1:4 ) = (/3, 2, 6, 5/) ! cell vertices of the tetrahedron # 4
            TetrahedronAux( 5 , 1:4 ) = (/3, 6, 7, 5/) ! cell vertices of the tetrahedron # 5
            TetrahedronAux( 6 , 1:4 ) = (/3, 7, 4, 5/) ! cell vertices of the tetrahedron # 6
   ...
   do k = kl , ku-1 !k_mysta-1, k_myend
   do j = jl , ju-1 !j_mysta-1, j_myend
   do i = il , iu-1 !i_mysta-1, i_myend
   ...
   print *, 'ContTetrahedra = ', ContTetrahedra-1
...
!   TotalWaterVolumeVar = zero
   ...
   if ( present( WriteGlobalVolume) ) then
      if (WriteGlobalVolume) then
