...
def write_ind3dmg(parameters):
    ...
    f.write(f"1.0 2.5 2.5\n")
    f.write(f"0.1 0.2 0.2\n")
...
def clean_output(parameters):
    ...
    p = parameters
    execute(f"rm conver*")
    execute(f"rm history*")
    execute(f"rm cpu_performance*")
    execute(f"rm error.err*")
    execute(f"rm run.out*")
    ...
    execute(f" rm combined/*")
    execute(f" rm debug/*")
    execute(f" rm debugfiles/*")
    execute(f" rm solufiles/*")
    execute(f" rm solus/*")
    execute(f" rm surface/*")
    execute(f" rm usolufiles/*")
