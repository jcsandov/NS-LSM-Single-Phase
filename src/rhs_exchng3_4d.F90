...
! 
! This is a modified version that reorganises the pack/communication/unpack
! sequence to ensure corner ghost nodes communication
! (Jorge Sandoval, 23rd April, 2024)
